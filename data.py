class ConstantData:
    ...
    user_test_data = [
        ['Иван', 'Иванов', 'Красноярск', 'Охотный Ряд', '88883704143',
         '13.12.2023', 'двое суток', 'чёрный жемчуг', '****************'],
        ['Виктория', 'Левин', 'Санкт-Петербург', 'Курская', '88883704143',
         '31.12.2023', 'трое суток', 'серая безысходность', '2-й подъезд']
    ]
